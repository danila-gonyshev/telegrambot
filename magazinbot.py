...
#Случай, если бот не понял сообщения
...
def welcome(message):
    #Кнопки после ввода команды /start
    ...
    if message.text == '/start':
        ...
        bot.send_message(message.chat.id, f'Привет, {message.from_user.first_name}!\nУ меня ты сможешь купить некоторые товары!\nКонтакт моего разработчика: https://t.me/danila_gonyshev', reply_markup=markup)
    else:
...
def info(message):
    if message.text == '🛍 Товары':
        ...
        webbrowser.open('https://t.me/danila_gonyshev')
...
bot.polling(none_stop=True) #Строчка, чтобы программа не останавливалась
